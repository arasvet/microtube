...
ALTER TABLE videos ADD COLUMN IF NOT EXISTS fts_tsv tsvector;

-- Тип событий
DO $$ BEGIN
    CREATE TYPE event_type AS ENUM ('view_start','view_complete','like','search_query','click_result');
EXCEPTION
...
CREATE TABLE IF NOT EXISTS events (
  ...
  query       text,
  dwell_ms    int,
  CONSTRAINT events_video_fk FOREIGN KEY (video_id) REFERENCES videos(id),
